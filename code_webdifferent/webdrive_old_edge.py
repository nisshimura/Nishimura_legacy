...
url =  "https://www.bing.com/search?q=python&form=PRNAM1&src=IE11TR&pc=EUPP_NMTE"
...
#         file = save_file + "\edge_" + str(index) + '_' + str(i) +".png"
...
for i in range (times_height):
    file = save_file + "\edge_" + str(i) +".png"
...
background.save("C:\programing\Atom_collection\screenshot_programing\edge_.png")
driver.quit()
