...
int main()
{
    ...
    for (i = 0; i < ny; i++)
    {
        for (j = 0; j < nx; j++)
        {
            ...
            {
                outimageR[i][j] = inputimageR[i][j + 1] + inputimageR[i + 1][j] + inputimageR[i + 1][j + 1]*-4 +inputimageR[i+1][j + 2] + inputimageR[i+2][j+1];
                outimageG[i][j] = inputimageG[i][j + 1] + inputimageG[i + 1][j] + inputimageG[i + 1][j + 1]*-4 + inputimageG[i + 1][j + 2] + inputimageG[i + 2][j + 1];
                outimageB[i][j] = inputimageB[i][j + 1] + inputimageB[i + 1][j] + inputimageB[i + 1][j + 1]*-4 + inputimageB[i + 1][j + 2] + inputimageB[i + 2][j + 1];
            }
        }
    } /////////////////////////////////////////////////////////////////////////////
