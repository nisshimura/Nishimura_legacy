...
int main()
{
    ...
    for (i = 0; i < ny; i++)
    {
        for (j = 0; j < nx; j++)
        {
            if (inputimageR[i][j] == 255.0)
                outimageR[i][j] = 0.0;
            else if (inputimageR[i][j] == 0.0)
                outimageR[i][j] = 255.0;
            else if (inputimageR[i][j] == 50.0)
                outimageR[i][j] = 205.0;

            if (inputimageG[i][j] == 255.0)
                outimageG[i][j] = 0.0;
            else if (inputimageG[i][j] == 0.0)
                outimageG[i][j] = 255.0;
            else if (inputimageG[i][j] == 50.0)
                outimageG[i][j] = 205.0;

            if (inputimageB[i][j] == 255.0)
                outimageB[i][j] = 0.0;
            else if (inputimageB[i][j] == 0.0)
                outimageB[i][j] = 255.0;
            else if (inputimageB[i][j] == 50.0)
                outimageB[i][j] = 205.0;
        }
    } /////////////////////////////////////////////////////////////////////////////
