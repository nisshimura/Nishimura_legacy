...
int main()
{
    ...
    printf("Input ganma : ");
    scanf("%f", &ganma);
    printf("Your input ganma:%f\n", ganma);

    for (i = 0; i < ny; i++)
    {
        for (j = 0; j < nx; j++)
        {
            outimageR[i][j] = 255*pow(inputimageR[i][j]/255,1/ganma);
            outimageG[i][j] = 255 * pow(inputimageG[i][j] / 255, 1 / ganma);
            outimageB[i][j] = 255 * pow(inputimageB[i][j] / 255, 1 / ganma);
        }
    }
    /////////////////////////////////////////////////////////////////////////////
